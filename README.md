...
В папке __TestTaskYadro/fileTestsCSV__ находятся тестовые файлы формата .CSV, над которыми испытал корректность работы программы при корректных и ошибочных ситуациях:
